...
Logger::Instance::Instance(const std::string &name) :
	_logMode(Logger::LogMode::OutputAndFile),
	_name(name),
	_time(Logger::Time())
{
...
Logger::Instance *Logger::Instance::getGlobalInstance(void)
{
	return (_globalInstance);
}

Logger::LogMode Logger::Instance::getLogMode(void) const
{
	return (_logMode);
}
...
std::string Logger::Instance::getTimeFormat(void) const
{
...
std::string Logger::Log::toString(void)
{
...
Logger::Time::~Time(void)
{
}

std::string Logger::Time::getFormat(void) const
{
	return (_format);
}
...
Logger::Time Logger::Time::now(void)
{
	_time = time(NULL);
	return (*this);
}
...
/*
	...
	s  ->  second
*/
std::string Logger::Time::toString(void)
{
	std::string s;
	struct tm *t;
